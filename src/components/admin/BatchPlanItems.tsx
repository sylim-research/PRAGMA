...
// 짧은 범주 칸은 고르게 나누고 장면 소재가 나머지를 쓴다 — 글자가 왼쪽에 몰리지 않게.
// 「장면 소재」 = 생성 시드(topic). 편성 주제(theme)와 다르다.
      ...
      <table className="w-full min-w-[820px] table-fixed text-[13px]">
        ...
        <thead className="whitespace-nowrap border-y bg-[#FAF8F2] text-muted-foreground">
          <tr><th rowSpan={2} className="px-2 py-2 text-center align-middle font-semibold">
            ...
            <th colSpan={3} className="border-b border-[#E6DECB] bg-[#F6EFDB] px-2 pb-1 pt-2 text-center text-[11.5px] font-semibold tracking-[0.02em] text-[#6D5C1F]">관계 조건 (P·D·R)</th>
