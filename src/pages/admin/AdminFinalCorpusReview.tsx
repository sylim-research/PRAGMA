...
const AdminFinalCorpusReview = ({ preview = false }: { preview?: boolean }) => {
  ...
  return <AdminShell title="과거 정식 생성 검토 기록" description="기존 정식 생성 작업의 검토 이력을 읽는 화면입니다. 현재 콘텐츠의 콘텐츠 검수·승인은 콘텐츠 검수·확정에서 진행합니다.">
    <div className="space-y-5">
      ...
      <section className="rounded-xl border border-sky-200 bg-sky-50 p-4 text-sm leading-6 text-sky-950">
        <strong>이력 범위:</strong> 과거 정식 생성 작업에 연결된 자동 점검과 연구자 검토 기록입니다. 전체 운영 콘텐츠의 점검률이나 현재 콘텐츠 검수 완료율이 아닙니다.
      </section>
