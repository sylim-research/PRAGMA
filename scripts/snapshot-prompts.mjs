...
const prompts = [
  ...
  entry("mission.system", "지시문 (번역)", "mission",
    "시나리오를 MJT 5문항·DCT형 통번역 과제 1개의 학습 미션으로 구성합니다.",
  ...
  entry("content_review.claude", "Claude 교차 검토", "review",
    "앞선 AI 검토 의견 없이 원본과 기준만으로 검토합니다.",
    S.buildReviewPrompt("claude", {}).system),
  entry("content_review.adjudication", "OpenAI 재검토", "review",
    "Claude 의견마다 수용·보완·기각 의견과 근거를 남깁니다.",
