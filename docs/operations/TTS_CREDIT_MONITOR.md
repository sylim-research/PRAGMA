...
관리자 화면에서도 같은 조회를 볼 수 있다: 운영 대시보드(`/admin/dashboard`) 맨 아래 「외부 서비스 연동」 절의 「지금 점검」
(2026-09-07, `docs/dev-log/2026-09-07-admin-service-health.md`). 이 패널은 버튼을 눌렀을 때만 조회하며 heartbeat를 대체하지 않는다.
