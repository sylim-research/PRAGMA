...
> [PR #109](https://github.com/sylim-research/PRAGMA/pull/109)의 첫 전체 CI에서 수업자료 테스트 3건이 옛 제목 단언 때문에 실패했다(846 통과·9 skip). `src/pages/admin/AdminTeachingMaterials.test.tsx`의 제목 단언 5곳만 “이 주차 수업자료 승인”으로 정렬했다. 동작 코드는 추가 변경하지 않았다.
